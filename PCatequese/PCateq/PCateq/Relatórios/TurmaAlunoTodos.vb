...
Public Class TurmaAlunoTodos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PCateq.TurmaAlunoTodos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTurmaAlunoTodos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TurmaAlunoTodos = New TurmaAlunoTodos()
        rpt.Site = Me.Site
        Return rpt
    End Function
