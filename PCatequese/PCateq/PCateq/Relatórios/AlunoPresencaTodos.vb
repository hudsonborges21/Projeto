...
Public Class AlunoPresencaTodos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PCateq.AlunoPresencaTodos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAlunoPresencaTodos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AlunoPresencaTodos = New AlunoPresencaTodos()
        rpt.Site = Me.Site
        Return rpt
    End Function
