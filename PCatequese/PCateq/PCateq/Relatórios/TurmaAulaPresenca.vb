...
Public Class TurmaAulaPresenca
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PCateq.TurmaAulaPresenca.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PAula() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTurmaAulaPresenca
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TurmaAulaPresenca = New TurmaAulaPresenca()
        rpt.Site = Me.Site
        Return rpt
    End Function
